...
Source: "build\Release\*"; DestDir: "{app}"; Excludes: "yt-dlp.exe,ffmpeg.exe,PrismDownloaderTests.exe,PrismMediaMetadataTests.exe,PrismMediaToolResolverTests.exe,PrismYtDlpUpdateServiceTests.exe,PrismAppUpdateServiceTests.exe,PrismPortableUpdateCommonTests.exe,PrismPortableUpdateHelper.exe,PrismFakeMediaTool.exe,PrismQueueManagerTests.exe"; Flags: ignoreversion recursesubdirs createallsubdirs

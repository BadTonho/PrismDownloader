...
Source: "build\Release\*"; DestDir: "{app}"; Excludes: "yt-dlp.exe,ffmpeg.exe,PrismDownloaderTests.exe,PrismFakeMediaTool.exe,PrismQueueManagerTests.exe"; Flags: ignoreversion recursesubdirs createallsubdirs

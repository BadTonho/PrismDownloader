...
<p align="center">
  <a href="../AUTO_UPDATE.md">🇺🇸 Read the English version here.</a>
</p>
...
O pipeline gera exatamente esses três artefatos com
`scripts/create_update_manifest.py`; o aplicativo rejeita nomes ausentes ou
inesperados antes de baixar qualquer pacote.
